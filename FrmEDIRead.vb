...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Friend WithEvents tbbtnDelLYG As System.Windows.Forms.ToolBarButton
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEDIRead))
        ...
        Me.tbbtnDelLYG = New System.Windows.Forms.ToolBarButton
        ...
        Me.GBV.Name = "GBV"
        Me.GBV.Size = New System.Drawing.Size(174, 447)
        Me.GBV.TabIndex = 1
        ...
        Me.C1DBGV.Size = New System.Drawing.Size(168, 339)
        Me.C1DBGV.TabIndex = 7
        ...
        ", 0, 164, 335</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=""Style2" & _
        ...
        "64, 335</ClientArea></Blob>"
        '
        'btResure
        '
        Me.btResure.Location = New System.Drawing.Point(128, 382)
        Me.btResure.Name = "btResure"
        Me.btResure.Size = New System.Drawing.Size(42, 22)
        Me.btResure.TabIndex = 6
        Me.btResure.Text = "查询"
        '
        'txtVoyage
        '
        Me.txtVoyage.Location = New System.Drawing.Point(38, 382)
        ...
        'txtShipName
        '
        Me.txtShipName.Location = New System.Drawing.Point(38, 358)
        ...
        Me.ToolBarV.Location = New System.Drawing.Point(3, 403)
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(538, 447)
        Me.GB.TabIndex = 2
        Me.GB.TabStop = False
        '
        'C1DBG
        ...
        Me.C1DBG.Location = New System.Drawing.Point(4, 94)
        ...
        Me.C1DBG.Size = New System.Drawing.Size(532, 348)
        ...
        "roup=""1""><ClientRect>0, 0, 528, 344</ClientRect><BorderSide>0</BorderSide><Capti" & _
        ...
        "th><ClientArea>0, 0, 528, 344</ClientArea></Blob>"
        '
        'Label
        '
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit, Me.tbbtnDelLYG})
        ...
        Me.tbbtnExport.Text = "清空"
        Me.tbbtnExport.ToolTipText = "清空"
        '
        'tbbtnSep3
        '
        ...
        'tbbtnDelLYG
        '
        Me.tbbtnDelLYG.ImageIndex = 4
        Me.tbbtnDelLYG.Text = "删装货港"
        '
        'FrmEDIRead
        '
...
#End Region
    ...
    Private Sub Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FirmShip = "where DEPT_CODE LIKE '" & G_DeptCode & "%'" '船舶不变的条件设计 
        'SqlStrShip = "where ((DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('1','2','3')) OR (Ship_Statu in ('1') and len(ltrim(BerthNo))=0)) "
        SqlStrShip = "where DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('1','2','3') "
        If G_User_Serial = "WLGCH" Then
            SqlStrShip = "where (DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('1','2','3','4') ) "
        End If
        Call myDataGridShip(SqlStrShip & inoutstr & SortShip)   '*****************调用航次信息
        Me.C1DBGV.SelectedStyle.BackColor = System.Drawing.Color.CornflowerBlue
        txtShipName.Text = G_ShipName
...
Err:
    ...
    Private Sub ToolBarV_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBarV.ButtonClick
        ...
        Case 1
                ...
                If G_User_Serial = "WLGCH" Then
                    SqlStrShip = "where (DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('1','2','3','4','0') ) "
                End If
                SortShip = " Order by Ship_Statu,Dept_Code,id desc "
                Call myDataGridShip(SqlStrShip & inoutstr & SortShip)
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        Call preview("WL4_1_1") '*****************权限设计 '*************要修改模块号
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from view_imagecargo where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 2 '不显示的列数 '******要修改
            Table_Name = "view_imagecargo" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        ...
        Dim sqldastr As New SqlClient.SqlDataAdapter
        Dim sqlda1 As New SqlClient.SqlDataAdapter
        Dim sqlt As String
        Dim sqls As String
        Dim sqlstr As String
        Dim JointTmp As String



        sqls = "select * from Con_Image_Record where Ship_ID=" & Ship_ID
        dws = Updatedata(sqlda1, sqls, dss)
        If dws.Count > 0 Then
            Dim i As Integer
            i = 0
            Try
                Dim Frm As New FrmNav
                Frm.Show()
                Frm.Refresh()
                Me.Refresh()
                Do While i < dws.Count

                    If Getdata("select * from Con_Image where Ship_ID=" & Ship_ID & " and CONTAINER_NO='" & dws(i)(2) & "'", dsm).Count = 0 Then

                        If (dws(i)(3) = 20 Or dws(i)(3) = 40 Or dws(i)(3) = 45 Or dws(i)(3) = 58) And (Asc(UCase(Mid(dws(i)(9), 1, 1))) >= Asc("A") And Asc(UCase(Mid(dws(i)(9), 1, 1))) <= Asc("Z")) Then
                            dsv.Reset()
                            sql = "select * from View_Map_Bay where V_ID=" & V_ID & " and (bay_num='" & Mid(dws(i)(6), 1, 2) & "' or ( Joint='1' and bay_num='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String))) - 1, 2) & " ')) and bay_col='" & Mid(dws(i)(6), 3, 2) & "' and bay_row='" & Mid(dws(i)(6), 5, 2) & "'"
                            JointTmp = "0"
                            dwv = Getdata(sql, dsv)
                            If dwv.Count > 0 Then
                                JointTmp = dwv(0)("Joint")
                                '*********************写入箱规范
                                dst.Reset()
                                ...
                                If dwt.Count = 0 Then
                                    ...
                                    row("Code_Con_Company") = dws(i)(39)
                                    If IsDBNull(dws(i)(22)) Then
                                        If dws(i)(3) = 20 Then
                                            row("CON_WEIGHT") = 2300
                                        ElseIf dws(i)(3) = 40 Then
                                            row("CON_WEIGHT") = 3800
                                        ElseIf dws(i)(3) = 45 Then
                                            row("CON_WEIGHT") = 4700
                                        End If
                                    Else
                                ...
                                Else
                                    ...
                                    dst.Tables(0).Rows(0).Item("Code_Con_Company") = dws(i)(39)
                                    If IsDBNull(dws(i)(22)) Then
                                        If dws(i)(3) = 20 Then
                                            dst.Tables(0).Rows(0).Item("CON_WEIGHT") = 2300
                                        ElseIf dws(i)(3) = 40 Then
                                            dst.Tables(0).Rows(0).Item("CON_WEIGHT") = 3800
                                        ElseIf dws(i)(3) = 45 Then
                                            dst.Tables(0).Rows(0).Item("CON_WEIGHT") = 4700
                                        End If
                                    Else
                                    ...
                                    dst.Tables(0).Rows(0).Item("Length") = dws(i)(47)
                                    dst.Tables(0).Rows(0).Item("Width") = dws(i)(48)
                                    dst.Tables(0).Rows(0).Item("Height") = dws(i)(49)
                                ...
                                sqlda.Dispose()
                                '*****************写入船图箱信息 bay col row 
                                'sqlt = "select * from Con_image where Ship_ID=" & Ship_ID & " and CONTAINER_NO='" & dws(i)(2) & "' and ( BayNo='" & dws(i)(6) & "' OR BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "' OR BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "')"
                                If JointTmp = "1" Then
                                    sqlt = "select * from Con_image where Ship_ID=" & Ship_ID & " and ( BayNo='" & dws(i)(6) & "' OR BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "' OR  BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "')"
                                Else
                                    sqlt = "select * from Con_image where Ship_ID=" & Ship_ID & " and ( BayNo='" & dws(i)(6) & "')"
                                End If
                                ...
                                If dwt.Count = 0 Then
                                    ...
                                    row("Demo") = dws(i)(45)
                                    row("ConDemo") = dws(i)(46)
                                    '******************未转换的代码
                                    row("CodeConType") = dws(i)(54)
                                    row("CodeLoadPort") = dws(i)(51)
                                    row("CodeUnLoadPort") = dws(i)(52)
                                    row("CodeDelivery") = dws(i)(53)
                                    row("Code_Con_Company") = dws(i)(39)
                                    '******************
                                    ...
                                    sqlda1.Update(dss)
                                Else
                                    If MsgBox("船图中有与此Bay 位号冲突的箱子 箱号：" & dws(i)(2) & " Bay位：" & dws(i)(6) & " , 继续吗?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                ...
                                sqlda.Dispose()
                            Else
                                If MsgBox("Bay 位规范中没有此Bay 位号：" & dws(i)(6) & ", 继续吗?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                    i = i + 1
                                    Frm.Refresh()
                                    Me.Refresh()
                                Else
                            ...
                            End If
                        Else
                            If MsgBox("箱型代码找不到：" & dws(i)(3) & dws(i)(9) & ", 继续吗?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                i = i + 1
                                Frm.Refresh()
                                Me.Refresh()
                            Else
                    ...
                    Else
                        sqlstr = "select * from Con_image where Ship_ID=" & Ship_ID & " and CONTAINER_NO='" & dws(i)(2) & "'"
                        '**********and ( BayNo='" & dws(i)(6) & "' OR BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) - 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "' OR BayNo='" & Mid("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String)), Len("0" & Trim(CType(CType(Mid(dws(i)(6), 1, 2), Int32) + 1, String))) - 1, 2) & Mid(dws(i)(6), 3, 4) & "')"

                        dsstr.Reset()
                        dwstr = Updatedata(sqldastr, sqlstr, dsstr)
                        If dwstr.Count = 1 Then
                            '*********************写入箱规范
                            dst.Reset()
                            sqlt = "select * from Con_Criterion where CONTAINER_NO='" & dws(i)(2) & "'"
                            dwt = Updatedata(sqlda, sqlt, dst)
                            ...
                            dst.Dispose()
                            sqlda.Dispose()
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("FULLOREMPTY")) Then
                            dsstr.Tables(0).Rows(0).Item("FULLOREMPTY") = dws(i)(4)
                            'End If
                            If dsstr.Tables(0).Rows(0).Item("Unload_Mark") = 0 Then
                                'If IsDBNull(dsstr.Tables(0).Rows(0).Item("BAYNO")) Then
                                dsstr.Tables(0).Rows(0).Item("BAYNO") = dws(i)(6)
                                'End If
                            End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("BLNO")) Then
                            dsstr.Tables(0).Rows(0).Item("BLNO") = dws(i)(7)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("AMOUNT")) Then
                            dsstr.Tables(0).Rows(0).Item("AMOUNT") = dws(i)(20)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("GrossWEIGHT")) Then
                            dsstr.Tables(0).Rows(0).Item("GrossWEIGHT") = dws(i)(21)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("VOLUME")) Then
                            dsstr.Tables(0).Rows(0).Item("VOLUME") = dws(i)(23)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CodeConType")) Then
                            dsstr.Tables(0).Rows(0).Item("CodeConType") = dws(i)(54)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CODE_LOAD_PORT")) Then
                            dsstr.Tables(0).Rows(0).Item("CODE_LOAD_PORT") = dws(i)(14)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("LOAD_PORT")) Then
                            dsstr.Tables(0).Rows(0).Item("LOAD_PORT") = dws(i)(15)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CODE_UnLOAD_PORT")) Then
                            dsstr.Tables(0).Rows(0).Item("CODE_UnLOAD_PORT") = dws(i)(16)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("UnLOAD_PORT")) Then
                            dsstr.Tables(0).Rows(0).Item("UnLOAD_PORT") = dws(i)(17)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CODE_DELIVERY")) Then
                            dsstr.Tables(0).Rows(0).Item("CODE_DELIVERY") = dws(i)(18)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("DELIVERY")) Then
                            dsstr.Tables(0).Rows(0).Item("DELIVERY") = dws(i)(19)
                            'End If

                            dsstr.Tables(0).Rows(0).Item("TEMPERATURE_UNIT") = dws(i)(24)
                            dsstr.Tables(0).Rows(0).Item("TEMPERATURE_SETTING") = dws(i)(25)
                            dsstr.Tables(0).Rows(0).Item("MAX_TEMPERATURE") = dws(i)(26)
                            dsstr.Tables(0).Rows(0).Item("MIN_TEMPERATURE") = dws(i)(27)
                            dsstr.Tables(0).Rows(0).Item("DANGER_GRADE") = dws(i)(33)
                            dsstr.Tables(0).Rows(0).Item("DANGER_PAGENO") = dws(i)(34)
                            dsstr.Tables(0).Rows(0).Item("DANGER_NO") = dws(i)(35)
                            dsstr.Tables(0).Rows(0).Item("DANGER_MARK") = dws(i)(36)
                            dsstr.Tables(0).Rows(0).Item("Demo") = dws(i)(45)
                            dsstr.Tables(0).Rows(0).Item("ConDemo") = dws(i)(46)
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CodeLoadPort")) Then
                            dsstr.Tables(0).Rows(0).Item("CodeLoadPort") = dws(i)(51)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CodeUnLoadPort")) Then
                            dsstr.Tables(0).Rows(0).Item("CodeUnLoadPort") = dws(i)(52)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("CodeDelivery")) Then
                            dsstr.Tables(0).Rows(0).Item("CodeDelivery") = dws(i)(53)
                            'End If
                            'If IsDBNull(dsstr.Tables(0).Rows(0).Item("Code_Con_Company")) Then
                            dsstr.Tables(0).Rows(0).Item("Code_Con_Company") = dws(i)(39)
                            'End If
                            dsstr.Tables(0).Rows(0).Item("User_Name") = G_User
                            '******************

                            sqldastr.Update(dsstr)
                        End If
                        dss.Tables(0).Rows(i).Delete()
                        sqlda1.Update(dss)
                    End If
    ...
    Private Sub C1DBG_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles C1DBG.KeyPress
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        Dim Frm As New FrmReadMail   '***********要修改
    ...
    Private Sub mnuPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuPrint.Click
        Call PrintExcel()
    End Sub
    Private Sub DeleteLYG()
        Dim FrmDelLoadPort As New FrmDelLoadPort

        FrmDelLoadPort.ShowDialog()
    ...
    Private Sub PrintExcel() '打印到Excel        
        ...
        Try
            ...
            For Row = 2 To ds.Tables(0).Rows.Count + 4 '画列
                xlSheet.Range(xlSheet.Cells(Row, 1), xlSheet.Cells(Row, 13 - ColNum)).Borders(Excel.XlBordersIndex.xlEdgeBottom).LineStyle = 7
            Next Row
            For Col = 1 To 13 - ColNum + 1 '画行
    ...
    Private Sub MakeExcel()
        ...
        Try
            FileCopy(PathStr + "\Report_Lxj.xls", PathStr + "\Report.xls")
    ...
    Private Sub preview(ByVal Func As String) '***************权限设计
        ...
        If Previewdv.Count > 0 Then
            ...
            If Previewdv(i)("FUNC_CODE_Del") = 1 Then '删除 按钮可见
                ...
                Me.ToolBar.Buttons.Item(11).Enabled = True
                mnuDelete.Enabled = True
            Else                                     '删除按钮不可见
                Me.ToolBar.Buttons.Item(5).Enabled = False
                Me.ToolBar.Buttons.Item(11).Enabled = False
