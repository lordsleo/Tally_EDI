...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmTray))
        ...
        "alScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>292</Height><CaptionStyle pa" & _
        ...
        "nt=""Normal"" me=""Style1"" /><ClientRect>0, 0, 396, 292</ClientRect><BorderSide>0</" & _
        ...
        "ecSelWidth><ClientArea>0, 0, 396, 292</ClientArea><PrintPageHeaderStyle parent=""" & _
...
#End Region
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from TRAY_CRITERION where " & Sql '******要修改

            Me.C1DBG.DataSource = Updatedata(sqlda, strsql, ds) ' class dbcontrol getdata fuction
            'ColNum = 1 '不显示的列数 '******要修改
            'Table_Name = "TRAY_CRITERION" '操作的数据库表名 ''******要修改
            ...
            Me.C1DBG.Columns.Item("TRAY").Caption = "拖车号"
            Me.C1DBG.Columns.Item("TRAY_CODE").Caption = "拖车代码"
            Me.C1DBG.Columns.Item("TRAY_SIZE").Caption = "尺寸"
            Me.C1DBG.Columns.Item("TRAY_WEIGHT").Caption = "重量"


            'for( int j= DBControl.ColNum;j<=DBControl.ds.Tables[0].Columns.Count-1 ;j++)
            '{
            '   this.C1DBG.Columns[j].FilterDropdown=true;
            '}
            'For j = 0 To ColNum - 1 
            'Me.C1DBG.Columns("TRAY_SIZE").FilterDropdown = True
            'Next
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmDelete As New FrmTray_Delete() '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmEdit As New FrmTray_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        'Dim FrmAdd As New FrmTray_Add() '***********要修改
        'If ds.Tables(0).Rows.Count > 0 Then
        '    ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        'Else
        '    ID = -1
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmQuery As New FrmTray_Query() '***********要修改
        '    ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        '    FrmQuery.ShowDialog()
        'End If
    End Sub
