...
Public Class FrmConTypeRelation_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtShipOwner
        '
        Me.txtShipOwner.Location = New System.Drawing.Point(96, 4)
        Me.txtShipOwner.Name = "txtShipOwner"
        Me.txtShipOwner.Size = New System.Drawing.Size(136, 20)
        Me.txtShipOwner.TabIndex = 142
        '
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(119, 88)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 140
        Me.btQuit.Text = "取消"
        '
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(51, 88)
        Me.btSave.Name = "btSave"
        Me.btSave.Size = New System.Drawing.Size(65, 24)
        Me.btSave.TabIndex = 139
        Me.btSave.Text = "确认"
        '
        'txtCon
        '
        Me.txtCon.Location = New System.Drawing.Point(96, 60)
        Me.txtCon.MaxLength = 12
        Me.txtCon.Name = "txtCon"
        Me.txtCon.Size = New System.Drawing.Size(136, 21)
        Me.txtCon.TabIndex = 137
        Me.txtCon.Text = ""
        '
        'Label5
        '
        ...
        'txtCode
        '
        Me.txtCode.Location = New System.Drawing.Point(96, 32)
        Me.txtCode.MaxLength = 12
        Me.txtCode.Name = "txtCode"
        Me.txtCode.Size = New System.Drawing.Size(136, 21)
        Me.txtCode.TabIndex = 134
        Me.txtCode.Text = ""
        '
        'Label3
        '
        ...
        Me.Name = "FrmConTypeRelation_Edit"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "船公司与箱型标准对照码_编辑"
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "CODE_CON_TYPE_RELATION", Trim(txtID.Text), "CODE_CON_TYPE_RELATION_ID")

                ds.Tables(0).Rows(0).Item("Code_Ship_Owner") = Trim(txtShipOwner.SelectedValue)
                ds.Tables(0).Rows(0).Item("CODE_CON_SHIP_TYPE") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("CODE_CON_TYPE_STANDARD") = Trim(txtCon.Text)
