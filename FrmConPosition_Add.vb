...
Public Class FrmConPosition_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(156, 118)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(88, 118)
        ...
        'btAdd
        '
        Me.btAdd.Location = New System.Drawing.Point(20, 118)
        Me.btAdd.Name = "btAdd"
        ...
        'txtENG
        '
        Me.txtENG.Location = New System.Drawing.Point(88, 60)
        ...
        'txtCHA
        '
        Me.txtCHA.Location = New System.Drawing.Point(88, 32)
        ...
        'txtCode
        '
        Me.txtCode.Location = New System.Drawing.Point(88, 4)
        ...
        Me.ClientSize = New System.Drawing.Size(240, 147)
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            ...
            If Getdata("select * from CODE_CON_POSITION where CODE_CON_POSITION='" & Trim(txtCode.Text) & "'", dsSave).Count > 0 Then
                MsgBox("可能已存在此部位信息,请注意检查!")
                Exit Sub
            End If
            If Len(Trim(txtCode.Text)) > 0 And Len(Trim(txtCHA.Text)) > 0 Then
                ...
                row("CODE_CON_POSITION") = Trim(txtCode.Text)
                row("POSITION_CHA") = Trim(txtCHA.Text)
                row("POSITION_ENG") = Trim(txtENG.Text)
                row("CON_POSITION_SHORT") = Trim(txtShort.Text)
                ds.Tables(0).Rows.Add(row)
                sqlda.Update(ds)
                Me.Close()
            Else
                MsgBox("部位代码不能为空!", MsgBoxStyle.Critical, "提示")
            End If
