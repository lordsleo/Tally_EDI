...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            Next
            Me.C1DBG.Columns.Item(0).Caption = "项目"
            Me.C1DBG.Columns.Item(1).Caption = "20重数"
            Me.C1DBG.Columns.Item(2).Caption = "20重吨"
            Me.C1DBG.Columns.Item(3).Caption = "40重数"
            Me.C1DBG.Columns.Item(4).Caption = "40重吨"
            Me.C1DBG.Columns.Item(5).Caption = "其它重数"
            Me.C1DBG.Columns.Item(6).Caption = "其它重吨"
            Me.C1DBG.Columns.Item(7).Caption = "20空数"
            Me.C1DBG.Columns.Item(8).Caption = "20空吨"
            Me.C1DBG.Columns.Item(9).Caption = "40空数"
            Me.C1DBG.Columns.Item(10).Caption = "40空吨"
            Me.C1DBG.Columns.Item(11).Caption = "其它空数"
            Me.C1DBG.Columns.Item(12).Caption = "其它空吨"
            Me.C1DBG.Columns.Item(13).Caption = "小计数"
            Me.C1DBG.Columns.Item(14).Caption = "小计吨"
