...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Frm_Bonus))
        ...
        Me.mnuCompile.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuEdit, Me.mnuDelete})
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnSep1, Me.tbbtnEdit, Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        "roup=""1""><ClientRect>0, 0, 484, 338</ClientRect><BorderSide>0</BorderSide><Capti" & _
        ...
        "th><ClientArea>0, 0, 484, 338</ClientArea></Blob>"
        '
        'Frm_Bonus
        '
...
#End Region
    ...
    Private Sub Frm_Bonus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connstr = conn_rs
        Me.WindowState = FormWindowState.Maximized

        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by dept_code,xuhao "
        DynaStr = " dept_code like '" & G_DeptCode + "%" & "'"              'G_DeptCode   为用户部门代码
        SelectStr = " Top 40 "
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            strsql = "select " & SelStr & " * from " & Table_Name & " where " & Sql
...
Err:
    ...
    Private Sub mnuPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuPrint.Click
        ...
        Dim FrmPrint As New Frm_Bonus_Print
        FrmPrint.ShowDialog()
        Try
            Call myDataGrid(SelectStr, SqlStr)
        Catch ex As Exception
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        Dim FrmAdd As New Frm_Bonus_Add
        FrmAdd.ShowDialog()
        Try
            Call myDataGrid(SelectStr, SqlStr)
