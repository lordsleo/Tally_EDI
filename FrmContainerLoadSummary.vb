...
Public Class FrmContainerLoadSummary
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmContainerLoadSummary))
...
#End Region
    ...
    Private Sub FrmContainerLoadSummary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub GetSheetExcel()
        ...
        sqlStateSumary = "SELECT CODE_UNLOAD_PORT, MAX(UNLOAD_PORT) AS UnloadPort, FULLOREMPTY, CONTAINER_TYPE, SIZE_CON, COUNT(*) AS ConNum, SUM(WEIGHT) AS ConWeight FROM View_ContainerLoadingSumary WHERE (CODE_LOAD_PORT <> 'LYG') GROUP BY CODE_UNLOAD_PORT, FULLOREMPTY, CONTAINER_TYPE, SIZE_CON ORDER BY CODE_UNLOAD_PORT, FULLOREMPTY, CONTAINER_TYPE, SIZE_CON"
        ...
        Try
            ...
            xlSheet.Cells(7 + 2 * i, 1) = "TOTAL" '填充总计数据
            ...
            xlSheet.Cells(7 + 2 * i, 10) = iAmountH20T + iAmountE20T
            xlSheet.Cells(7 + 2 * i, 11) = iAmountH40T + iAmountE40T
            xlSheet.Cells(7 + 2 * i, 12) = iAmountH45T + iAmountE45T
            xlSheet.Cells(7 + 2 * i, 13) = iAmountH58T + iAmountE58T

            xlSheet.Cells(8 + 2 * i, 2) = fWeightH20T
            xlSheet.Cells(8 + 2 * i, 3) = fWeightH40T
            xlSheet.Cells(8 + 2 * i, 4) = fWeightH45T
            xlSheet.Cells(8 + 2 * i, 5) = fWeightH58T
            xlSheet.Cells(8 + 2 * i, 6) = fWeightE20T
            xlSheet.Cells(8 + 2 * i, 7) = fWeightE40T
            xlSheet.Cells(8 + 2 * i, 8) = fWeightE45T
            xlSheet.Cells(8 + 2 * i, 9) = fWeightE58T
            xlSheet.Cells(8 + 2 * i, 10) = fWeightH20T + fWeightE20T
            xlSheet.Cells(8 + 2 * i, 11) = fWeightH40T + fWeightE40T
            xlSheet.Cells(8 + 2 * i, 12) = fWeightH45T + fWeightE45T
            xlSheet.Cells(8 + 2 * i, 13) = fWeightH58T + fWeightE58T
