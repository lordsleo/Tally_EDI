...
Public Class FrmEDIINI
    ...
    Friend WithEvents txtCSFile As System.Windows.Forms.TextBox
    Friend WithEvents OpenCSFile As System.Windows.Forms.Button
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtCSFile = New System.Windows.Forms.TextBox
        Me.OpenCSFile = New System.Windows.Forms.Button
        Me.SuspendLayout()
        '
        'txtSendFile
        '
        ...
        'btResure
        '
        Me.btResure.Location = New System.Drawing.Point(177, 177)
        ...
        'txtCSFile
        '
        Me.txtCSFile.Location = New System.Drawing.Point(59, 145)
        Me.txtCSFile.Name = "txtCSFile"
        Me.txtCSFile.Size = New System.Drawing.Size(322, 21)
        Me.txtCSFile.TabIndex = 28
        '
        'OpenCSFile
        '
        Me.OpenCSFile.Location = New System.Drawing.Point(383, 145)
        Me.OpenCSFile.Name = "OpenCSFile"
        Me.OpenCSFile.Size = New System.Drawing.Size(32, 20)
        Me.OpenCSFile.TabIndex = 27
        Me.OpenCSFile.Text = "..."
        '
        'FrmEDIINI
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(418, 210)
        Me.Controls.Add(Me.Label4)
        Me.Controls.Add(Me.txtCSFile)
        Me.Controls.Add(Me.OpenCSFile)
        Me.Controls.Add(Me.btResure)
        Me.Controls.Add(Me.Label3)
        Me.Controls.Add(Me.txtReceiveFile)
        Me.Controls.Add(Me.OpenRFile)
        Me.Controls.Add(Me.Label2)
        Me.Controls.Add(Me.txtBackUpFile)
        Me.Controls.Add(Me.OpenBFile)
        Me.Controls.Add(Me.Label1)
        Me.Controls.Add(Me.txtSendFile)
        Me.Controls.Add(Me.OpenSFile)
...
#End Region
    ...
    Private Sub btResure_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResure.Click
        ...
        sw.WriteLine(txtCSFile.Text)
        sw.Close()
        Me.Close()
    End Sub

    Private Sub OpenCSFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenCSFile.Click
        OpenFileDialog.AddExtension = True
        OpenFileDialog.DefaultExt = "*.*"
        OpenFileDialog.InitialDirectory = txtCSFile.Text
        OpenFileDialog.ShowDialog()
        txtBackUpFile.Text = OpenFileDialog.FileName
    End Sub
End Class
