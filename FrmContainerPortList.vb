...
Public Class FrmContainerPortList
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmContainerPortList))
...
#End Region
    ...
    Private Sub FrmContainerPortList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        Call preview("WL3_1_19_3") '*****************权限设计 '*************要修改模块号
    ...
    Private Sub GetSheetExcel()
        ...
        Try
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                ...
                iResult = Fix(i / 6)    '一页六条记录
                iRemainder = i - iResult * 6
                iResultSub = Fix(iRemainder / 2)    '每页两行
