...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmEDIWrite))
        ...
        'btResure
        '
        Me.btResure.Location = New System.Drawing.Point(128, 336)
        ...
        'txtVoyage
        '
        Me.txtVoyage.Location = New System.Drawing.Point(38, 336)
        ...
        'txtShipName
        '
        Me.txtShipName.Location = New System.Drawing.Point(38, 312)
        ...
        Me.tbbtnQuery.Text = "生成"
        Me.tbbtnQuery.ToolTipText = "生成"
        '
        'tbbtnSep1
        '
...
#End Region
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        If dw.Count > 0 Then
            ...
            ShipOwner = dsShip.Tables(0).Rows(0).Item("Code_ShipOwner")
            NextPort = dsShip.Tables(0).Rows(0).Item("Next_Port")
            If Not IsDBNull(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")) Then
                EndTime = Mid(Trim(CType(Year(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")), String)), 3, 2)
                EndTime = EndTime & Mid("0" & Trim(CType(Month(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")), String)), Len("0" & Trim(CType(Month(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")), String))) - 1, 2)
                EndTime = EndTime & Mid("0" & Trim(CType(Day(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")), String)), Len("0" & Trim(CType(Day(dsShip.Tables(0).Rows(0).Item("SAILING_TIME")), String))) - 1, 2)
        ...
        End If
        dsShip.Reset()
        strsql = "select * from Code_Ship_Owner where Code_ShipOwner='" & ShipOwner & "'"
        dw = Getdata(strsql, dsShip)
        If dw.Count > 0 Then
            ShipCompany = dsShip.Tables(0).Rows(0).Item("ShipOwner_Eng")
        End If
...
Err:
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmEdit As New FrmEDIWrite_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        ...
        '            sqlt = "select * from Code_Type_Ship_Relation where CONTAINER_NO='" & dws(i)(2) & "' and CODE_SHIP_OWNER='" & dws(i)(37) & "'"
        '            dwt = Updatedata(sqlda, sqlt, dst)
        '            If dwt.Count = 0 Then
        '                Dim row As DataRow
        ...
        '            dst.Reset()
        '            '*****************写入船图箱信息 bay col row 
        '            sqlt = "select * from Con_image where Ship_ID=" & Ship_ID & " and CONTAINER_NO='" & dws(i)(2) & "'"
        '            dwt = Updatedata(sqlda, sqlt, dst)
        '            If dwt.Count = 0 Then
        '                Dim row As DataRow
        '                row = dst.Tables(0).NewRow()
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        Dim Frm As New FrmWriteMail   '***********要修改
