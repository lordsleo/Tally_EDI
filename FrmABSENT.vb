...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmABSENT))
        ...
        Me.tbbtnPrint.Text = "管理人员考勤"
        Me.tbbtnPrint.ToolTipText = "管理人员考勤"
        '
        'tbbtnSep2
        '
...
#End Region
    ...
    Private Sub FrmABSENT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Call preview("WL10_50") '*****************权限设计 '*************要修改模块号
        ...
        '集装箱增加EDI班, 陶明月021045, 吴炎020908, 许涛190853, 邱杰184568
        DynaStr = " (DEPT_CODE= '" & G_DeptCode & "' or DEPT_CODE ='29." & Mid(Trim(G_DeptCode), 4) & "') and (datediff(MM,ABSENTDATE,GETDATE())=1 or datediff(MM,ABSENTDATE,GETDATE())=0) and (Code_HOLIDAY_TYPE between 1 and 89) and work_no in ('021045','020908','190853','111008') "  '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " " ' " Top 20 "
