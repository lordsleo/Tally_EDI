...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(538, 384)
        Me.GB.TabIndex = 9
        Me.GB.TabStop = False
        '
        'Label
        ...
        Me.Label.Location = New System.Drawing.Point(3, 16)
        Me.Label.Name = "Label"
        Me.Label.Size = New System.Drawing.Size(413, 37)
        ...
        Me.C1DBG.Size = New System.Drawing.Size(532, 320)
        ...
        Me.GBV.Name = "GBV"
        Me.GBV.Size = New System.Drawing.Size(166, 384)
        Me.GBV.TabIndex = 8
        ...
        Me.btResure.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.btResure.Location = New System.Drawing.Point(122, 321)
        ...
        Me.txtVoyage.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtVoyage.Location = New System.Drawing.Point(32, 321)
        ...
        Me.Label2.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.Label2.Location = New System.Drawing.Point(2, 323)
        ...
        Me.txtShipName.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtShipName.Location = New System.Drawing.Point(32, 299)
        ...
        Me.Label1.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.Label1.Location = New System.Drawing.Point(2, 301)
        ...
        Me.ToolBarV.Location = New System.Drawing.Point(3, 340)
        ...
        Me.C1DBGV.Size = New System.Drawing.Size(160, 280)
...
Err:
    ...
    Private Sub myDataGrid(ByVal shipid As String)
        ...
        strsql = "SELECT id, worktype, dx, cntr, bayno, truckno, ioport, work_no,NAME,instime, message FROM con_info,TALLY_CLERK where con_info.workno=TALLY_CLERK.work_no and shipid='" & shipid & "'" & "order by id desc"

        Me.C1DBG.DataSource = Getdata(strsql, ds)
        ColNum = 3 '不显示的列数
        Table_Name = "con_info" '操作的数据库表名
    ...
    Private Sub SetColumnCaption()
        ...
        Try
            ...
            Me.C1DBG.Columns.Item(4).Caption = "贝位号"
            Me.C1DBG.Columns.Item(5).Caption = "车号"
            Me.C1DBG.Columns.Item(6).Caption = "进/出"
            Me.C1DBG.Columns.Item(7).Caption = "工号"
            Me.C1DBG.Columns.Item(8).Caption = "姓名"
            Me.C1DBG.Columns.Item(9).Caption = "指令时间"
            Me.C1DBG.Columns.Item(10).Caption = "指令信息"
        Catch ex As System.Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub SetColumnWidth()
        Try
            ...
            Next
            Me.C1DBG.Splits(0).DisplayColumns.Item(Me.C1DBG.Columns.Count - 1).MinWidth = 150
        Catch ex As System.Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub SetColumnSum(ByVal Col As String)
        ...
        Me.C1DBG.Columns.Item(Col).FooterText = "共 " & C1DBG.Splits(0).Rows.Count & " 条"
        'Me.C1DBG.Columns.Item(Col).FooterText = "共 " & C1DBG.RowCount & " 条"  
    End Sub
    ...
    Private Sub Form1_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        'Me.C1DBG.Top = Label.Location.Y + Label.Height - 10
        Me.C1DBG.Width = Me.GB.Width - 30
        Me.C1DBG.Height = Me.GB.Height - Me.Label.Height - 30
    End Sub
    ...
    Private Sub C1DBG_AfterFilter(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FilterEventArgs) Handles C1DBG.AfterFilter
        Me.C1DBG.Columns.Item("cntr").FooterText = "共 " & C1DBG.Splits(0).Rows.Count & " 条"
    End Sub
