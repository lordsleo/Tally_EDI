...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(File_bak))
        ...
        "=""1""><Height>285</Height><CaptionStyle parent=""Style2"" me=""Style10"" /><EditorSty" & _
        ...
        ", 0, 164, 285</ClientRect><BorderSide>0</BorderSide><BorderStyle>Sunken</BorderS" & _
        ...
        "</Layout><DefaultRecSelWidth>16</DefaultRecSelWidth><ClientArea>0, 0, 164, 285</" & _
            ...
            Case 3
                ...
                ElseIf Flag = 2 Then
                    ...
                    If G_User_Serial <> "wlgch" Then
                        SqlStrShip = "where (DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('2','3') ) "
                    Else
                        SqlStrShip = "where (DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('2','3','4') ) "
                    End If
                    '可能要修改
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        ...
        Try
            ...
            wjbc.Filter = "PDF文件(*.pdf)|*.pdf|Excel文件(*.xls)|*.xls|All files (*.*)|*.*"
