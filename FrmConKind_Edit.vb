...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(124, 92)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 205
        Me.btQuit.Text = "取消"
        '
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(56, 92)
        Me.btResume.Name = "btResume"
        Me.btResume.Size = New System.Drawing.Size(65, 24)
        Me.btResume.TabIndex = 204
        Me.btResume.Text = "确认"
        '
        'txtCode
        '
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            ...
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_CON_Kind", Trim(txtID.Text), "CON_Kind_ID")

                ds.Tables(0).Rows(0).Item("CODE_CON_KIND") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("CON_KIND_CHI") = Trim(txtCHI.Text)
                ds.Tables(0).Rows(0).Item("CON_KIND_ENG") = Trim(txtENG.Text)
