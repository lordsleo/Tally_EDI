...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Friend WithEvents mnuBills As System.Windows.Forms.MenuItem
    Friend WithEvents tbbtnBill As System.Windows.Forms.ToolBarButton
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.mnuBills = New System.Windows.Forms.MenuItem
        ...
        Me.tbbtnBill = New System.Windows.Forms.ToolBarButton
        Me.GB.SuspendLayout()
        ...
        " HorizontalScrollGroup=""1""><ClientRect>0, 0, 538, 300</ClientRect><BorderSide>0<" & _
        ...
        "</DefaultRecSelWidth><ClientArea>0, 0, 538, 300</ClientArea><PrintPageHeaderStyl" & _
        "e parent="""" me=""Style14"" /><PrintPageFooterStyle parent="""" me=""Style15"" /></Blob" & _
        ">"
        '
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnBill, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        Me.mnuCompile.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuAdd, Me.mnuEdit, Me.mnuDelete, Me.mnuBills})
        ...
        'tbbtnBill
        '
        Me.tbbtnBill.Text = "提单处理"
        Me.tbbtnBill.ToolTipText = "按提单处理互租箱位"
        '
        'FrmConRent
        '
...
#End Region
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        If dsShip.Tables(0).DefaultView.Count > 0 Then
            ...
            End If
            If Not IsDBNull(dwship(0)("AGENT")) Then
                strAgent = Trim(dwship(0)("AGENT"))
            Else
                strAgent = ""
            End If
        End If
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            Dim sqlShipAgent As String = "SELECT CODE_SHIP_AGENT, SHIPAGENT_CHA, SHIPAGENT_ENG, SHIPAGENT_SHORT  FROM CODE_SHIP_AGENT ORDER BY SHIPAGENT_SHORT"
...
Err:
    ...
    Private Sub mnuBills_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuBills.Click
        Dim fmRentDeal As New FrmConRent_BillNew
        fmRentDeal.strAgent = strAgent
        fmRentDeal.ShowDialog()
        If fmRentDeal.blSave Then
