...
#End Region
    ...
    Private Sub Sendmail(ByVal Sendto As String, ByVal From As String)
        ...
        If UCase(Mid(Trim(txtFile.Text), Len(Trim(txtFile.Text)) - 2, 3)) <> "TXT" Then
            ...
            FileName = txtFile.Text & UCase(txtShipCode.Text) & LVoyage.Text & "TLYRST.txt"
...
Err:
    ...
    Private Sub btRead_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btRead.Click
        ...
        strFile = txtFile.Text & UCase(txtShipCode.Text) & LVoyage.Text & "TLYRST.txt"
    ...
    Private Sub WriteHG()
        ...
        If j < dw.Count Then
            ...
            '************写15
            txtLine = "15:" & DS_DO.Tables(0).Rows(j).Item("c20") & ":" & DS_DO.Tables(0).Rows(j).Item("c40") & ":0:0:0:0:0'"
            sw.WriteLine(txtLine)
            j = j + 1
            i = i + 1
            PB.Value = j
            '************写21
            txtLine = "21:" & DS_DO.Tables(0).Rows(j).Item("c20") & ":" & DS_DO.Tables(0).Rows(j).Item("c40") & ":0:0:0:0:0'"
            sw.WriteLine(txtLine)
            j = j + 1
            i = i + 1
            PB.Value = j
            '************写22
            txtLine = "22:" & DS_DO.Tables(0).Rows(j).Item("c20") & ":" & DS_DO.Tables(0).Rows(j).Item("c40") & ":0:0:0:0:0'"
            sw.WriteLine(txtLine)
            j = j + 1
            i = i + 1
            PB.Value = j
            '************写23
            txtLine = "23:" & DS_DO.Tables(0).Rows(j).Item("c20") & ":" & DS_DO.Tables(0).Rows(j).Item("c40") & ":0:0:0:0:0'"
            sw.WriteLine(txtLine)
            j = j + 1
            i = i + 1
            PB.Value = j
            '************写24
            txtLine = "24:" & DS_DO.Tables(0).Rows(j).Item("c20") & ":" & DS_DO.Tables(0).Rows(j).Item("c40") & ":0:0:0:0:0'"
            sw.WriteLine(txtLine)
            j = j + 1
            i = i + 1
