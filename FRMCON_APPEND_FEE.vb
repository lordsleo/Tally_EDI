...
Public Class FRMCON_APPEND_FEE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRMCON_APPEND_FEE))
...
#End Region
    ...
    Private Sub FRMCON_APPEND_FEE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        If ds_sship.Tables(0).Rows.Count > 0 Then
            ...
            If trade = "1" Then
                dw = Getdata("exec spcon_append_fee '" & Ship_ID & "'", DS_DO)

            ElseIf trade = "2" Then
                dw = Getdata("exec spcon_append_fee_eng '" & Ship_ID & "'", DS_DO)
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            Me.C1DBG.Columns.Item("c20fp").Caption = "20重件"
            Me.C1DBG.Columns.Item("c20ft").Caption = "20重吨"

            Me.C1DBG.Columns.Item("c40fp").Caption = "40重件"
            Me.C1DBG.Columns.Item("c40ft").Caption = "40重吨"
            Me.C1DBG.Columns.Item("c20ep").Caption = "20空件"
            Me.C1DBG.Columns.Item("c20et").Caption = "20空吨"
            Me.C1DBG.Columns.Item("c40ep").Caption = "40空件"
            Me.C1DBG.Columns.Item("c40et").Caption = "40空吨"
