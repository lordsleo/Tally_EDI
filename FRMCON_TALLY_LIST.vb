...
Public Class FRMCON_TALLY_LIST
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRMCON_TALLY_LIST))
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnDOPRINT, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        'tbbtnDOPRINT
        '
        Me.tbbtnDOPRINT.ImageIndex = 8
        Me.tbbtnDOPRINT.Text = "预配"
        Me.tbbtnDOPRINT.ToolTipText = "预配"
        '
        'tbbtnPrint
        '
...
#End Region
    ...
    Private Sub FRMCON_TALLY_LIST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from VIEW_CON_TALLY_LIST  where " & Sql '******要修改
...
Err:
    ...
    Private Sub PrintExcel() '打印到Excel   
        Dim dstally As New DataSet '要打印的理箱单
        Dim dstally_sub As New DataSet
        Dim dwtally As New DataView
        Dim dwtally_sub As New DataView

        Try
            If ds.Tables(0).Rows.Count > 0 Then
                ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
                dwtally = Getdata("select * from CON_TALLY_LIST where CON_TALLY_LIST_ID='" & ID & "' ", dstally)
            End If
