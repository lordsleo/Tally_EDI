...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmConOpen))
        ...
        Me.C1DBGV.Size = New System.Drawing.Size(160, 313)
        ...
        Me.txtVoyage.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        Me.txtVoyage.Location = New System.Drawing.Point(32, 354)
        ...
        Me.txtShipName.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        Me.txtShipName.Location = New System.Drawing.Point(32, 332)
...
#End Region
    ...
    Private Sub FrmConOpen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        Call preview("WL4_8") '*****************权限设计 '*************要修改模块号
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            Dim sqlConState As String
            Dim dvState As New DataView()
            sqlConState = "SELECT EFL_Code, EFL_Name FROM Code_ConEFLType"
            dvState = Filldata(sqlConState)

            Dim sqlContain As String = "SELECT CON_TALLY_DETAIL_ID, CONTAINER_NO,BAYNO,SIZE_CON,SEALNO,FULLOREMPTY,OPENBOX FROM CON_TALLY_DETAIL WHERE CON_TALLY_LIST_ID IN (SELECT con_tally_list_id FROM con_tally_list WHERE ship_id = '" & Ship_ID & "')  and " & Sql
            ...
            For i = 0 To dvState.Count - 1
                ...
                VI.DisplayValue = dvState.Item(i)(1)
                VI.Value = dvState.Item(i)(0)
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmDeal As New FrmConOpen_Deal()       '***********要修改
        FrmDeal.ShowDialog()
        'Try
        ...
        Try
            ...
            'For i = 0 To Me.C1DBG.SelectedRows.Count - 1
            '    Me.C1DBG.Row = Me.C1DBG.SelectedRows.Item(i)
            '    Me.C1DBG.Columns("OPENBOX").Value = 1
            'Next
            'Me.C1DBGV.Focus()
            'sqlda.Update(ds)
            Call myDataGrid(SelectStr, SqlStr)
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        Try
            If MessageBox.Show("确实要对所选记录的拆箱查验标志还原吗？", "操作提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
                Dim i As Short
                For i = 0 To Me.C1DBG.SelectedRows.Count - 1
                    Me.C1DBG.Row = Me.C1DBG.SelectedRows.Item(i)
                    Me.C1DBG.Columns("OPENBOX").Value = 0
                Next
                Me.C1DBGV.Focus()
                sqlda.Update(ds)
                Call myDataGrid(SelectStr, SqlStr)
