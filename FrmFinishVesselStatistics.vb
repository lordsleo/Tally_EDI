...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.C1Arch.Images.Add(CType(resources.GetObject("resource"), System.Drawing.Image))
        Me.C1Arch.Location = New System.Drawing.Point(186, 0)
        ...
        "er;}Normal{BackColor:Window;}HighlightRow{ForeColor:HighlightText;BackColor:High" & _
        "light;}Style9{}OddRow{}RecordSelector{AlignImage:Center;}Heading{Wrap:True;Align" & _
        "Vert:Center;Border:Raised,,1, 1, 1, 1;ForeColor:ControlText;BackColor:Control;}S" & _
        "tyle8{}Style10{AlignHorz:Near;}Style11{}Style12{}Style13{}Style1{}</Data></Style" & _
        "s><Splits><C1.Win.C1TrueDBGrid.MergeView Name="""" AllowRowSizing=""None"" CaptionHe" & _
        ...
        "HorizontalScrollGroup=""1""><ClientRect>0, 0, 522, 321</ClientRect><BorderSide>0</" & _
        ...
        "ertSplits><horzSplits>1</horzSplits><Layout>None</Layout><DefaultRecSelWidth>16<" & _
        "/DefaultRecSelWidth><ClientArea>0, 0, 522, 321</ClientArea></Blob>"
        '
        'Panel1
        '
        ...
        Me.Panel1.Size = New System.Drawing.Size(712, 325)
        ...
        Me.Splitter1.Size = New System.Drawing.Size(2, 325)
        ...
        Me.C1DBG.Size = New System.Drawing.Size(184, 325)
        ...
        "roup=""1""><ClientRect>0, 0, 180, 321</ClientRect><BorderSide>0</BorderSide><Capti" & _
        ...
        "th><ClientArea>0, 0, 180, 321</ClientArea></Blob>"
        '
...
#End Region
    ...
    Private Sub myDataGrid()
        ...
        Try
            ...
            Next
            Call SetColumnCaption(Me.C1DBG)  '设计列标题
            Call SetColumnWidth(Me.C1DBG)  '设计列宽度
            'If ds.Tables(0).Rows.Count > 0 Then
            '    Call SetColumnSum("1=1") '设计合计列
            'End If
            Me.C1DBG.Columns.Item(ColNum).FooterText = "合计" & ds.Tables(0).Rows.Count & "条"

            strsql2 = "select * from Statis_FinishVessel where " & DynaStr
...
Err:
    ...
    Private Sub GetSheetExcel(ByVal RecordCount As Integer, ByRef CompOne As C1.Win.C1TrueDBGrid.C1TrueDBGrid)
        ...
        Try
            ...
            For Col = 1 To 18       '画列线
                ...
                End If
            Next
            xlSheet.Cells(2, 1) = CompOne.Columns("SHIPAGENT_CHA").Text & CompOne.Columns("Trade").Text
    ...
    Private Sub C1DBG_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        ...
        If DynaStr <> "1=1" Then
            sqlDelStatis = "delete Statis_FinishVessel where " & DynaStr
            sqlInsertStatis = "insert into Statis_FinishVessel select * from View_FinishVessel where " & DynaStr
