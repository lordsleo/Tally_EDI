...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.mnuEdibyconts.Text = "预发理货报告(&P)..."
        '
        'mnuEdibypda
        '
        Me.mnuEdibypda.Index = 4
        Me.mnuEdibypda.Text = "已理箱理货报告(&P)..."
        '
        'mnuPrint
        '
        Me.mnuPrint.Enabled = False
        Me.mnuPrint.Index = 5
        Me.mnuPrint.Text = "生成理货报告(&P)..."
        ...
        Me.tbbtnPrint.Text = "理货报告"
        Me.tbbtnPrint.ToolTipText = "理货报告"
        '
        'tbbtnSep3
        '
        Me.tbbtnSep3.ImageIndex = 12
        Me.tbbtnSep3.Name = "tbbtnSep3"
        Me.tbbtnSep3.Text = "预发报文"
        Me.tbbtnSep3.ToolTipText = "理货报告预发"
        '
        'tbbtnExport
        '
...
#End Region
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        End If
        FirmStr = " and Ship_ID=" & Ship_ID & " Order by EDIMark DESC " '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
        ...
        Call preview("WL4_1_4") '*****************权限设计 '*************要修改模块号
        Call myDataGrid(SelectStr, SqlStr)

        Me.C1DBG.SelectedStyle.BackColor = Color.CornflowerBlue  '设计选择纪录底色
        Exit Sub
Err:
        Resume Next
    End Sub
    ...
    Private Sub SetColumnSum(ByVal sql As String)
        ...
        Me.C1DBG.Columns.Item("blno").FooterText = "合计 共" & ds.Tables(0).Rows.Count & "条"
        Do While i < Me.C1DBG.Columns.Count
            j = 0
            For j = 0 To dset.Tables(0).Rows.Count - 1
...
Err:
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        Dim Frm As New FrmWriteMailList   '***********要修改
    ...
    '    '    MessageBox.Show("本航次已存在独立发送报文！")
    '    '    Return
    '    'End If
    '    Dim Frm As New FrmWriteMailReport   '*********** 理货报告报文 要修改
    '    Frm.LChina.Text = LChina
    '    Frm.LEnglish.Text = LEng
    '    Frm.LVoyage.Text = LVoyage
    '    Frm.LJinChu.Text = LJinChu
