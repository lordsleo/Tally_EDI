...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btQuit.Location = New System.Drawing.Point(302, 348)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(234, 348)
        ...
        Me.ccbNewSealNo.MaxDropDownItems = CType(5, Short)
        ...
        Me.ccbContainer.MaxDropDownItems = CType(5, Short)
...
#End Region
    ...
    Private Sub FrmConSealExam_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dw.Count > 0 Then
            ...
            '选出本部门可用铅封号以及自身
            sqlSealNo = "select SEALNO from SEAL_RECORD where SEALNO='" & strSealNO & "' or Dept_Code= '" & G_DeptCode & "' and SEAL_STATE = '2' and Use_Mark='0' and Logout_Mark='0' order by SEALNO "
...
Err:
            ...
            If Trim(txtNo.Text) <> "" Then
                If ccbContainer.SelectedValue <> Nothing Then
                    If DateDiff(DateInterval.Minute, Me.dtpTimeBegin.Value, Me.dtpTimeEnd.Value) >= 0 Then
                        If ccbNewSealNo.SelectedValue <> Nothing Or strNewSeal = "" Or strNewSeal = strSealNO Then
                            Mark = True
                        Else
    ...
    Private Sub EditSealExam(ByVal strNewSeal As String, ByVal strOldSeal As String)
        ...
        ds.Tables(0).Rows(0).Item("CONTAINER_NO") = ccbContainer.Text
        ...
        ds.Tables(0).Rows(0).Item("SealType") = cbSealKind.SelectedValue
        ds.Tables(0).Rows(0).Item("SealPerson") = cbSealPerson.SelectedValue
    ...
    Private Sub cbContainer_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim i As Integer
        'For i = 0 To Count - 1
        '    If Me.C1DBG.Columns("CONTAINER_NO").CellValue(i) = Trim(Me.ccbContainer.Text) Then Exit For
        'Next
        'If i < Count Then
        '    Me.C1DBG.Row = i
        '    Me.txtOriginalSealNO.Text = Me.C1DBG.Columns("SEALNO").Text
